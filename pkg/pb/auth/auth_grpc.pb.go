...
const (
	...
	AuthService_GetAvatar_FullMethodName     = "/auth.AuthService/GetAvatar"
)
...
type AuthServiceClient interface {
	...
	UploadAvatar(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadAvatarRequest, User], error)
	GetAvatar(ctx context.Context, in *GetAvatarRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAvatarResponse], error)
}
...
func (c *authServiceClient) UploadAvatar(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[UploadAvatarRequest, User], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AuthService_ServiceDesc.Streams[0], AuthService_UploadAvatar_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[UploadAvatarRequest, User]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AuthService_UploadAvatarClient = grpc.ClientStreamingClient[UploadAvatarRequest, User]

func (c *authServiceClient) GetAvatar(ctx context.Context, in *GetAvatarRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetAvatarResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AuthService_ServiceDesc.Streams[1], AuthService_GetAvatar_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetAvatarRequest, GetAvatarResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AuthService_GetAvatarClient = grpc.ServerStreamingClient[GetAvatarResponse]
...
type AuthServiceServer interface {
	...
	UploadAvatar(grpc.ClientStreamingServer[UploadAvatarRequest, User]) error
	GetAvatar(*GetAvatarRequest, grpc.ServerStreamingServer[GetAvatarResponse]) error
...
func (UnimplementedAuthServiceServer) UploadAvatar(grpc.ClientStreamingServer[UploadAvatarRequest, User]) error {
	return status.Error(codes.Unimplemented, "method UploadAvatar not implemented")
}
func (UnimplementedAuthServiceServer) GetAvatar(*GetAvatarRequest, grpc.ServerStreamingServer[GetAvatarResponse]) error {
...
func _AuthService_UploadAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AuthServiceServer).UploadAvatar(&grpc.GenericServerStream[UploadAvatarRequest, User]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AuthService_UploadAvatarServer = grpc.ClientStreamingServer[UploadAvatarRequest, User]
...
func _AuthService_GetAvatar_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AuthServiceServer).GetAvatar(m, &grpc.GenericServerStream[GetAvatarRequest, GetAvatarResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AuthService_GetAvatarServer = grpc.ServerStreamingServer[GetAvatarResponse]
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		},
		{
			...
			Handler:       _AuthService_GetAvatar_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "auth.proto",
