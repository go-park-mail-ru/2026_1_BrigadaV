...
INSERT INTO "user" (email, nickname, avatar_url, password_hash) VALUES
...
INSERT INTO trip (title, description, start_date, end_date, created_by, is_public) VALUES
    ('Поездка в Европу', 'Посещение Парижа и Рима', '2025-06-01', '2025-06-15', 1, true),
    ('Отдых на Бали', 'Пляжный отдых', '2025-07-10', '2025-07-20', 2, false);
...
ALTER TABLE "user" DROP CONSTRAINT IF EXISTS email_format;
ALTER TABLE "user" DROP CONSTRAINT IF EXISTS nickname_length;
