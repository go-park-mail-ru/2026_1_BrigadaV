...
func main() {
	...
	r.HandleFunc("/api/profile/update", authMiddleware.Authenticate(profileHandler.UpdateProfile)).Methods("PUT")
	r.HandleFunc("/api/profile/change-password", authMiddleware.Authenticate(profileHandler.ChangePassword)).Methods("PUT")
